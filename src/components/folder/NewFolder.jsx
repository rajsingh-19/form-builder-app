...
const NewFolder = ({folderName, folderId, onDelete, className}) => {
  return (
    <div className={`${styles.newFolder} flex dir-row align-center position-relative`}>
        <button className={`${styles.folderName} ${className} font-open-sans font-wt-400 text-18 text-white bg-transparent outline-none border-none cursor-pointer`}>{folderName}</button>
